			...
			<ul>
				<c:choose>
					<c:when test='${param.menu == "main" }'>
						...
						<li><a href="${pageContext.servletContext.contextPath }/board?a=&page=1">게시판</a></li>
					</c:when>
					...
					<c:when test='${param.menu == "board" }'>
						...
						<li><a href="${pageContext.servletContext.contextPath }/guestbook">방명록</a></li>
						<li><a href="${pageContext.servletContext.contextPath }/guestbook?a=ajax">방명록(Ajax)</a></li>
						<li class="selected"><a href="${pageContext.servletContext.contextPath }/board?a=&page=1">게시판</a></li>
					</c:when>
